...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("study.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("study.security.DomainUserDetailsService", "createSpringSecurityUser");
