...
import study.DocumentSignApp;
import study.config.AsyncSyncConfiguration;
import study.config.EmbeddedSQL;
...
@SpringBootTest(classes = { DocumentSignApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
