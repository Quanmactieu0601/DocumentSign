...
export class UserManagementUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    firstName: ['', [Validators.maxLength(49)]],
    lastName: ['', [Validators.maxLength(49)]],
    email: ['', [Validators.maxLength(49), Validators.email]],
    commonName: ['', [Validators.maxLength(99)]],
    ...
    langKey: [],
    authorities: [],
    currentPassword: ['', [Validators.minLength(5), Validators.maxLength(29)]],
    password: ['', [Validators.minLength(5), Validators.maxLength(29)]],
    confirmPassword: ['', [Validators.minLength(5), Validators.maxLength(29)]],
  });
