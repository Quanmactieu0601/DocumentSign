...
export class UserManagementUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    commonName: ['', [Validators.maxLength(100)]],
    organizationName: ['', [Validators.maxLength(100)]],
    organizationUnit: ['', [Validators.maxLength(100)]],
    localityName: ['', [Validators.maxLength(100)]],
    ...
    langKey: [],
    authorities: [],
    currentPassword: ['', [Validators.minLength(5), Validators.maxLength(30)]],
