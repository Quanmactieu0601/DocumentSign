...
export class AlertErrorComponent implements OnDestroy {
  ...
  constructor(
    ...
    this.httpErrorListener = eventManager.subscribe('webappApp.httpError', (response: JhiEventWithContent<HttpErrorResponse>) => {
        ...
        case 400: {
          ...
          if (errorHeader) {
            ...
            for (const fieldError of fieldErrors) {
              ...
              const fieldName = translateService.instant('webappApp.' + fieldError.objectName + '.' + convertedField);
