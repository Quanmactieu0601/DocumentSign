...
export class SystemConfigComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.systemConfigService
      ...
      .subscribe(
        (res: HttpResponse<ISystemConfig[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSystemConfigs(): void {
    this.eventSubscriber = this.eventManager.subscribe('systemConfigListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISystemConfig[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
