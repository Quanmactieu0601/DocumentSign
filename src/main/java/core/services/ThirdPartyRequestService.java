...
public class ThirdPartyRequestService {
    ...
    public ThirdPartyRequestService(
        ...
        OfficeSigningService officeSigningService,
        XMLSigningService xmlSigningService,
        PDFSigningService pdfSigningService,
        PDFSigningRequest pdfSigningRequest,
        RawSigningRequest rawSigningRequest,
        HashSigningRequest hashRequestSigning,
        HashSigningRequest hashSigningRequest,
        OfficeSigningRequest officeSigningRequest,
        XmlSigningRequest xmlSigningRequest
    ) {
