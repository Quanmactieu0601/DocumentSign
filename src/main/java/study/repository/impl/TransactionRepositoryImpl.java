...
//import study.enums.*;
//import study.repository.TransactionRepositoryCustom;
...
//        Optional<User> userEntityOptional = userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin().blockOptional().get()).blockOptional();
