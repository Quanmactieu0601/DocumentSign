...
/**
 * A DTO for the {@link study.domain.SignatureTemplate} entity.
 */
public class SignatureTemplateDTO implements Serializable {
    ...
    public SignatureTemplateDTO(
        ...
        Instant createdDate,
        String htmlTemplate,
        SignatureTemplateParserType coreParser,
        Integer width,
        Integer height,
        String thumbnail,
        Boolean activated,
    ...
    public String getCoreParser() {
        return coreParser;
    }

    public void setCoreParser(String coreParser) {
        this.coreParser = coreParser;
    }
