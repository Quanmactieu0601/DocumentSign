package vn.easyca.signserver.sign.core.cryptotoken.utils;
...
public class DnComponents {
    ...
    // Default values
    static {
        oids.put("c", NameStyle.C);
        oids.put("dc", NameStyle.DC);
        oids.put("st", NameStyle.ST);
        oids.put("l", NameStyle.L);
        oids.put("o", NameStyle.O);
        oids.put("ou", NameStyle.OU);
        oids.put("t", NameStyle.T);
        oids.put("surname", NameStyle.SURNAME);
        oids.put("initials", NameStyle.INITIALS);
        oids.put("givenname", NameStyle.GIVENNAME);
        oids.put("gn", NameStyle.GIVENNAME);
        oids.put("sn", NameStyle.SN);
        oids.put("serialnumber", NameStyle.SERIALNUMBER);
        oids.put("cn", NameStyle.CN);
        oids.put("uid", NameStyle.UID);
        oids.put("dn", NameStyle.DN_QUALIFIER);
        oids.put("emailaddress", NameStyle.EmailAddress);
        oids.put("e", NameStyle.EmailAddress);
        oids.put("email", NameStyle.EmailAddress);
        oids.put("unstructuredname", NameStyle.UnstructuredName); //unstructuredName
        oids.put("unstructuredaddress", NameStyle.UnstructuredAddress); //unstructuredAddress
        oids.put("postalcode", NameStyle.POSTAL_CODE);
        oids.put("businesscategory", NameStyle.BUSINESS_CATEGORY);
        oids.put("postaladdress", NameStyle.POSTAL_ADDRESS);
        oids.put("telephonenumber", NameStyle.TELEPHONE_NUMBER);
        oids.put("pseudonym", NameStyle.PSEUDONYM);
        oids.put("street", NameStyle.STREET);
        oids.put("name", NameStyle.NAME);
        oids.put("description", NameStyle.DESCRIPTION);
        oids.put("jurisdictionlocality", NameStyle.JURISDICTION_LOCALITY);
        oids.put("jurisdictionstate", NameStyle.JURISDICTION_STATE);
        oids.put("jurisdictioncountry", NameStyle.JURISDICTION_COUNTRY);
        oids.put("organizationidentifier", NameStyle.ORGANIZATION_IDENTIFIER);
