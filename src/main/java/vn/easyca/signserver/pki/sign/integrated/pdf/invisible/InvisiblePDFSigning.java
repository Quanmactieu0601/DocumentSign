...
public class InvisiblePDFSigning {
    ...
    private void signDetached(String name, String reason, SignatureInterface signature, File inFile, File outFile) throws
        IOException {
    ...
    private void signDetached(String name, String reason, SignatureInterface signature, PDDocument
        document, OutputStream output) throws IOException {
