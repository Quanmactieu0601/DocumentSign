...
public class P12ImportService {
    ...
    @Autowired
    public P12ImportService(CertificateService certificateService, UserApplicationService userApplicationService, CertPackageService certPackageService,
                            SymmetricEncryptors symmetricService, CertificateRepository certificateRepository, SystemConfigCachingService systemConfigCachingService, AuthenticatorTOTPService authenticatorTOTPService, CertificateGenerateService certificateGenerateService, CryptoTokenProxyFactory cryptoTokenProxyFactory) {
