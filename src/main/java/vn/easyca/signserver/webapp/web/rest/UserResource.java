...
public class UserResource extends BaseResource {
    ...
    public UserResource(UserApplicationService userApplicationService, UserRepository userRepository, PasswordEncoder passwordEncoder, MailService mailService, AsyncTransactionService asyncTransactionService, FileResourceService fileResourceService) {
