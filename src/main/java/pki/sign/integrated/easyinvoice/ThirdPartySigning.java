...
import core.dto.sign.request.SignRequest;
import core.dto.sign.response.SignDataResponse;
import core.dto.sign.response.SignResultElement;
import core.exception.ApplicationException;
import core.exception.CertificateNotFoundAppException;
import core.services.SigningService;
...
import pki.sign.integrated.easyinvoice.rsspDTO.SignatureHashData;
import pki.sign.integrated.easyinvoice.rsspDTO.SigningHashData;
import pki.sign.integrated.easyinvoice.rsspDTO.Types;
import pki.sign.integrated.easyinvoice.rsspDTO.request.RsSignHashesRequest;
import pki.sign.integrated.easyinvoice.rsspDTO.response.RASignHashResponse;
import pki.sign.integrated.easyinvoice.rsspDTO.response.RsSignHashResponse;
import pki.sign.utils.X509Utils;
import study.service.CertificateService;
import study.web.rest.vm.request.sign.SignElementVM;
...
public class ThirdPartySigning {
    ...
    public RASignHashResponse mapEasySigningResponse(
        SignDataResponse<List<SignResultElement>> signingDataResponse,
        SignThirdPartyRequest request
    ) {
