...
public class CSRGenerator {
    ...
    public String genCsr(
        ...
        PublicKey publicKey,
        String signatureAlg,
        Boolean withHeaderAndFooter,
        Boolean ldapOder
    ) throws CSRGeneratorException {
        try {
            ...
            if (x500Subject == null) throw new Exception("subjectDn string is not in right format");
            ...
            ContentSigner signer = new BufferingContentSigner(
                new JcaContentSignerBuilder(signatureAlg).setProvider(providerName).build(privateKey),
                20480
            );
    ...
    private X500Name getOrderedX500Name(
